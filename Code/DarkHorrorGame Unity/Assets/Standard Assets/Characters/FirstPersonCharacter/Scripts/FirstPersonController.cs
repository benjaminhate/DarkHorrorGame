...
namespace Standard_Assets.Characters.FirstPersonCharacter.Scripts
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            var oldQueryTriggerValue = Physics.queriesHitTriggers;
            ...
            Physics.queriesHitTriggers = oldQueryTriggerValue;
        ...
        private void UpdateCameraPosition(float speed)
        {
            ...
            if (m_CharacterController.velocity.magnitude > 0 && m_CharacterController.isGrounded)
            {
                ...
                (myTransform = m_Camera.transform).localPosition =
                ...
                newCameraPosition.y = localPosition.y - m_JumpBob.Offset();
            }
            else
            {
